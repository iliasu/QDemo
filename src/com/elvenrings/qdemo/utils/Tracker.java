...
public class Tracker
{
	...
	public void init(int first, int last, int current) throws TrackerException
	{
		...
		if( current > last)
		{
			throw new IllegalArgumentException("Parameter current: " +current + " should be <= parameter last: " + last);
		}
		if( current < first)
		{
			throw new IllegalArgumentException("Parameter current: " +current + " should be >= parameter first: " + first);
		}
