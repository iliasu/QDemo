...
/** A class representing the options available for a question 
 * accepting a text or series of texts to fill in the blanks.
...
public class FillBlank implements Choice
{
	...
	/**Accepts an array of regex values and sets these as the 
	 * patterns against which answers will be matched.
	 * @param regexList An array of regex strings.
	 */
	...
	/**Matches the provided list of strings against the set regex
	 * patterns in this class.
	 * @param answers An array of strings representing answers
	 * @return true if ALL answers match their respective regex patterns;
	 * false otherwise. Returns false also if the number of strings differ
	 * from the number of patterns.
	 * */
